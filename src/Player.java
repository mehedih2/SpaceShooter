...
/**
 * Player spaceship controlled by arrow keys / WASD.
 * Demonstrates OOP: Inheritance (extends GameObject), Encapsulation
 */
public class Player extends GameObject {

    private static final int SPEED      = 5;
    private static final int BULLET_CD  = 15; // frames between shots
